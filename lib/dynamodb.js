'use strict';
	...
	DynamoDB.prototype.table = function($tableName) {
		return new Request( this.client, { events: this.events, describeTables: this.describeTables, explain: this.explain, } ).table($tableName)
	}


	DynamoDB.prototype.query = function() {
		var r = new Request( this.client, { events: this.events, describeTables: this.describeTables, explain: this.explain, } )
