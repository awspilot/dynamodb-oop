'use strict';
	...
	DynamoDB.prototype.table = function($tableName) {
		return new Request( this.client, { events: this.events, describeTables: this.describeTables, return_explain: this.return_explain, } ).table($tableName)
	}


	DynamoDB.prototype.query = function() {
		var r = new Request( this.client, { events: this.events, describeTables: this.describeTables, return_explain: this.return_explain, } )
	...
	Request.prototype.routeCall = function(method, params, reset ,callback ) {
		...
		console.log("routeCall return_explain=", JSON.stringify(this.return_explain) )
