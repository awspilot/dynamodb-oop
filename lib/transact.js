...
var util = require('@awspilot/dynamodb-util')
	...
	Transact.prototype.eq = function( value ) {
		...
		if (this.pending.if !== null) {
			...
			var _name = this._namefy( this.pending.if.attr, '#if_' )
			...
			this.pending.ConditionExpression.push(
				"( " + _name + " = :if_" + this.pending.if.attr  + ")"
			)
	...
	Transact.prototype._namefy = function( name, prefix ) {
		...
		var _att_name = prefix + _expr_attribute(name)
		this.pending.ExpressionAttributeNames [ _att_name ] = name;
		return _att_name;
	}
	...
	Transact.prototype.ne = function( value ) {
		if (this.pending.if !== null) {
			...
			this.pending.ConditionExpression.push(
				"( " + _name + " <> :ifne_" + this.pending.if.attr  + ")"
			)
			this.pending.if = null;
			return this
		}
	...
	Transact.prototype.ge = function( value ) {
		if (this.pending.if !== null) {
			...
			this.pending.ConditionExpression.push(
				"( " + _name + " >= :ifge_" + this.pending.if.attr  + ")"
			)
			this.pending.if = null;
			return this
		}
	...
	Transact.prototype.gt = function( value ) {
		if (this.pending.if !== null) {
			...
			this.pending.ConditionExpression.push(
				"( " + _name + " > :ifgt_" + this.pending.if.attr  + ")"
			)
			this.pending.if = null;
			return this
		}
	...
	Transact.prototype.le = function( value ) {
		if (this.pending.if !== null) {
			...
			this.pending.ConditionExpression.push(
				"( " + _name + " <= :ifle_" + this.pending.if.attr  + ")"
			)
			this.pending.if = null;
			return this
		}
	...
	Transact.prototype.lt = function( value ) {
		if (this.pending.if !== null) {
			...
			this.pending.ConditionExpression.push(
				"( " + _name + " < :iflt_" + this.pending.if.attr  + ")"
			)
			this.pending.if = null;
			return this
		}
	...
	Transact.prototype.between = function( v1,v2 ) {
		if (this.pending.if !== null) {
			...
			if (this.pending.if.not === true) {
				...
				this.pending.ConditionExpression.push(
					"(NOT ( " + _name + " BETWEEN :ifnotbtwlo_" + this.pending.if.attr  + " AND :ifnotbtwhi_" + this.pending.if.attr  + "))"
				)
			} else {
				...
				this.pending.ConditionExpression.push(
					"( " + _name + " BETWEEN :ifbtwlo_" + this.pending.if.attr  + " AND :ifbtwhi_" + this.pending.if.attr  + ")"
				)
			}
			this.pending.if = null;
