	...
	Transact.prototype.contains = function( value ) {
		if (this.pending.if !== null) {
			...
			if (this.pending.if.not === true) {
				...
				this.pending.ConditionExpression.push(
					"( NOT contains( " + _name + " , :ifnotcontains_" + this.pending.if.attr  + ") )"
				)
			} else {
				...
				this.pending.ConditionExpression.push(
					"contains( " + _name + " , :ifcontains_" + this.pending.if.attr  + ")"
				)
			}
			this.pending.if = null;
	...
	Transact.prototype.begins_with = function( value ) {
		if (this.pending.if !== null) {
			...
			if (this.pending.if.not === true) {
				...
				this.pending.ConditionExpression.push(
					"(NOT begins_with( " + _name + " , :ifnotbw_" + this.pending.if.attr  + "))"
				)
			} else {
				...
				this.pending.ConditionExpression.push(
					"begins_with( " + _name + " , :ifbw_" + this.pending.if.attr  + ")"
				)
			}
			this.pending.if = null;
