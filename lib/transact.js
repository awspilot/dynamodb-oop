...
var util = require('@awspilot/dynamodb-util')
	...
	Transact.prototype._valuefy = function( name, prefix, value ) {
		...
		var _att_name = prefix + name.split('-').join('_minus_')

		this.pending.ExpressionAttributeValues[ _att_name ] = value
		return _att_name;
	}
	...
	Transact.prototype.ne = function( value ) {
		if (this.pending.if !== null) {
			...
			var _vname = this._valuefy( this.pending.if.attr, ':ifne_',  util.stringify(value) )
	...
	Transact.prototype.ge = function( value ) {
		if (this.pending.if !== null) {
			...
			var _vname = this._valuefy( this.pending.if.attr, ':ifge_',  util.stringify(value) )
	...
	Transact.prototype.gt = function( value ) {
		if (this.pending.if !== null) {
			...
			var _vname = this._valuefy( this.pending.if.attr, ':ifgt_',  util.stringify(value) )
	...
	Transact.prototype.le = function( value ) {
		if (this.pending.if !== null) {
			...
			var _vname = this._valuefy( this.pending.if.attr, ':ifle_',  util.stringify(value) )
	...
	Transact.prototype.lt = function( value ) {
		if (this.pending.if !== null) {
			...
			var _vname = this._valuefy( this.pending.if.attr, ':iflt_',  util.stringify(value) )
	...
	Transact.prototype.contains = function( value ) {
		if (this.pending.if !== null) {
			...
			if (this.pending.if.not === true) {
				...
				var _vname = this._valuefy( this.pending.if.attr, ':ifnotcontains_',  util.stringify(value) )
				this.pending.ConditionExpression.push(
					"( NOT contains( " + _name + " , " + _vname + ") )"
				)
			} else {
				var _name = this._namefy( this.pending.if.attr, '#ifcontains_' )
				var _vname = this._valuefy( this.pending.if.attr, ':ifcontains_',  util.stringify(value) )
